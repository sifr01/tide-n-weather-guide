```bash
curl -X GET "https://api.stormglass.io/v2/solar/point?lat=41.683&lng=-8.833&params=uvIndex" -H "Authorization: api_key_here"
```
...
```json
{
  "hours": [
    ...
    },
    {
      ...
      "uvIndex": { "noaa": 0.01, "sg": 0.01 }
    },
    {
      "time": "2026-02-15T10:00:00+00:00",
      "uvIndex": { "noaa": 0.02, "sg": 0.02 }
    },
    {
      "time": "2026-02-15T11:00:00+00:00",
      "uvIndex": { "noaa": 0.03, "sg": 0.03 }
    },
    {
      "time": "2026-02-15T12:00:00+00:00",
      "uvIndex": { "noaa": 0.04, "sg": 0.04 }
    },
    {
